...
struct RecordingGRPCService: Recoto_Recording_V1_RecordingService.SimpleServiceProtocol {
    ...
    private func validateUpdateJobRequest(_ updatable: Job.Updatable, jobId: String, logger: Logger) throws {
    ...
    private func mapJobUseCaseError(
    ...
    private func mapUnexpectedJobError(
        _ error: Error,
        operation: JobRPCOperation,
        logger: Logger
    ) -> RPCError {
    ...
    private func logJobOperationFailure(
        operation: JobRPCOperation,
        grpcStatus: String,
        reason: String,
        logger: Logger
